import 'package:dart_format/src/Data/CommentInfo.dart';
                    ...
                    test('Empty text', ()
                        {
                            ...
                            const CommentInfo expectedResult = CommentInfo(isEmpty: true);

                            final CommentInfo actualResult = CommentTools.analyze(inputText);
